...
| [farlock](https://github.com/shaneraphel/aletheia-farlock/blob/main/SHOW.md) | [numpy/numpy](https://github.com/numpy/numpy) | empty `norm` is 0.0 | Manhattan span 12 |
| [pulselock](https://github.com/shaneraphel/aletheia-pulselock/blob/main/SHOW.md) | [numpy/numpy](https://github.com/numpy/numpy) | empty `sum` is 0.0 | pulse strength 22 |
